...
#### Console Output - Automated Test Suite

```plaintext
========================================
Automated ALU Test Suite (CPU-level)
========================================

----------------------------------------
Testing ALU op = 000 (ADD)
----------------------------------------
T=15000  | PC=0 | IR=00000000 | A=0  | alu_op=000 | alu_b=0 | carry=0 | zero=0 | halted=0
T=35000  | PC=1 | IR=00010000 | A=10 | alu_op=000 | alu_b=0 | carry=0 | zero=0 | halted=0
T=55000  | PC=2 | IR=01010000 | A=10 | alu_op=000 | alu_b=5 | carry=0 | zero=0 | halted=0
T=65000  | PC=2 | IR=01010000 | A=15 | alu_op=000 | alu_b=5 | carry=0 | zero=0 | halted=0
T=85000  | PC=3 | IR=00110010 | A=15 | alu_op=000 | alu_b=5 | carry=0 | zero=0 | halted=0
CPU HALTED at 95000 | PC=3 | A=15
Result: A=15 | MEM[18]=15 | Carry=0 | Zero=0 ✓ PASS

----------------------------------------
Testing ALU op = 001 (SUB)
----------------------------------------
T=260000 | PC=1 | IR=00010000 | A=10 | alu_op=000 | alu_b=0 | carry=0 | zero=0 | halted=0
T=280000 | PC=2 | IR=01010001 | A=10 | alu_op=001 | alu_b=5 | carry=0 | zero=0 | halted=0
T=290000 | PC=2 | IR=01010001 | A=5  | alu_op=001 | alu_b=5 | carry=0 | zero=0 | halted=0
CPU HALTED at 320000 | PC=3 | A=5
Result: A=5 | MEM[18]=5 | Carry=0 | Zero=0 ✓ PASS

----------------------------------------
Testing ALU op = 010 (AND)
----------------------------------------
T=490000 | PC=1 | IR=00010000 | A=10 | alu_op=000 | alu_b=0 | carry=0 | zero=0 | halted=0
T=510000 | PC=2 | IR=01010010 | A=10 | alu_op=010 | alu_b=5 | carry=0 | zero=0 | halted=0
T=520000 | PC=2 | IR=01010010 | A=0  | alu_op=010 | alu_b=5 | carry=0 | zero=1 | halted=0
CPU HALTED at 550000 | PC=3 | A=0
Result: A=0 | MEM[18]=0 | Carry=0 | Zero=1 ✓ PASS

----------------------------------------
Testing ALU op = 011 (OR)
----------------------------------------
T=720000 | PC=1 | IR=00010000 | A=10 | alu_op=000 | alu_b=0 | carry=0 | zero=0 | halted=0
T=740000 | PC=2 | IR=01010011 | A=10 | alu_op=011 | alu_b=5 | carry=0 | zero=0 | halted=0
T=750000 | PC=2 | IR=01010011 | A=15 | alu_op=011 | alu_b=5 | carry=0 | zero=0 | halted=0
CPU HALTED at 780000 | PC=3 | A=15
Result: A=15 | MEM[18]=15 | Carry=0 | Zero=0 ✓ PASS

----------------------------------------
Testing ALU op = 100 (INC)
----------------------------------------
T=950000 | PC=1 | IR=00010000 | A=10 | alu_op=000 | alu_b=0 | carry=0 | zero=0 | halted=0
T=970000 | PC=2 | IR=01010100 | A=10 | alu_op=100 | alu_b=0 | carry=0 | zero=0 | halted=0
T=980000 | PC=2 | IR=01010100 | A=11 | alu_op=100 | alu_b=0 | carry=0 | zero=0 | halted=0
Result: A=11 | Carry=0 | Zero=0 ✓ PASS


```

*Console output from automated ALU test suite showing successful execution of all arithmetic and logical operations with correct accumulator values, flag generation, and memory updates*
